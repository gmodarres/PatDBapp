 ...
 */
public class SegIntrpr extends javax.swing.JFrame {
        ...
        this.setIconImage(img.getImage());
         ...
         this.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                SearchResult.SegIntrprIsOpen = false;
    ...
    private void initComponents() {
        ...
        txtArea_segIntrpr = new javax.swing.JTextArea();
        rbtn_alwaysOnTop = new javax.swing.JRadioButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Segmental Interpretation");

        txtArea_segIntrpr.setColumns(20);
        txtArea_segIntrpr.setLineWrap(true);
        txtArea_segIntrpr.setRows(2);
        txtArea_segIntrpr.setWrapStyleWord(true);
        jScrollPane1.setViewportView(txtArea_segIntrpr);

        rbtn_alwaysOnTop.setSelected(true);
    ...
    public static javax.swing.JTextArea txtArea_segIntrpr;
